...
const siteData = {
    ...
    newsradar: {
      ...
      description: `
        ...
        <ul>
          ...
          <li>Developed front-end interface allowing analysts to customize search terms and LLM prompts without coding</li>
        ...
        <ul>
          ...
          <li><strong>95% relevance accuracy:</strong> Automated filtering exceeds manual identification while processing thousands of key terms</li>
          <li><strong>Production stability:</strong> 7 weeks of autonomous daily operation with under 1 hour upload time</li>
          <li><strong>Scalable architecture:</strong> Custom prompt engineering allows non-technical users to adapt search criteria</li>
        </ul>
      `,
  ...
  uchicago: {
    ...
    dataScience: {
      ...
      altair: {
        title: "Interactive Data Visualization with Altair",
        description: `
          <p>Created a sophisticated interactive dashboard using Altair for exploring California housing data with UMAP dimensionality reduction and coordinated visualizations.</p>
          
          <p><strong>Project Highlights:</strong></p>
          <ul>
            <li>Implemented UMAP (Uniform Manifold Approximation and Projection) to reduce high-dimensional housing features into 2D visualization space</li>
            <li>Designed coordinated multi-view visualizations with interactive selections and filtering</li>
            <li>Created brushing and linking between geographic maps, scatter plots, and distribution histograms</li>
          </ul>
          
          <p><strong>Technical Implementation:</strong> Used Altair's declarative grammar for complex interactions, Pandas for data manipulation, and UMAP for dimensionality reduction. The dashboard reveals hidden patterns in housing prices based on location, demographics, and property characteristics.</p>
          
          <p><strong>Ethical Design:</strong> Carefully considered ethical implications of housing data visualization, including potential for reinforcing discriminatory patterns. Implemented design choices to emphasize data-driven insights while avoiding harmful stereotypes.</p>
        `,
        gifPath: "assets/uchicago/altair-demo.gif"
      },
      ...
      mlModels: [
        {
          name: "Random Forest",
          icon: "🌳",
          description: "Ensemble learning for classification and regression. Built models for NBA salary prediction and customer segmentation with feature importance analysis.",
          experience: "Advanced"
        },
        {
          name: "Neural Networks (PyTorch)",
          icon: "🧠",
          description: "Deep learning frameworks for complex pattern recognition. Implemented feedforward and convolutional architectures for image classification and time series prediction.",
          experience: "Intermediate"
        },
        {
          name: "Multilinear Regression",
          icon: "📈",
          description: "Statistical modeling for continuous outcomes. Applied regularization techniques (Ridge, Lasso, Elastic Net) to prevent overfitting in high-dimensional data.",
          experience: "Advanced"
        },
        {
          name: "K-Means Clustering",
          icon: "🎯",
          description: "Unsupervised learning for data segmentation. Used for customer clustering, image compression, and exploratory data analysis with elbow method for optimal k selection.",
          experience: "Advanced"
        },
        {
          name: "Hierarchical Clustering",
          icon: "🌲",
          description: "Agglomerative clustering for discovering data hierarchies. Applied to gene expression analysis and market segmentation with dendrogram visualization.",
          experience: "Intermediate"
        },
        {
          name: "Gradient Boosting",
          icon: "⚡",
          description: "Advanced ensemble method for high-performance predictions. Utilized XGBoost and LightGBM for competition-grade models with hyperparameter tuning.",
          experience: "Intermediate"
        }
      ]
    }
